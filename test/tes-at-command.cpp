...
void loop() {
  if (GPRS.available()) // if date is comming from softwareserial port ==> data
                        // is comming from gprs shield
  {
    ...
    clearBufferArray(); // call clearBufferArray function to clear the storaged
                        // data from the array
